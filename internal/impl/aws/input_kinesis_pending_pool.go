...
// CanAcquire checks if there's any space available in the pool.
// This is used to decide whether to listen on the records channel.
func (p *globalPendingPool) CanAcquire() bool {
	p.mu.Lock()
	defer p.mu.Unlock()
